  ...
  /*Active link*/
  const navLink = document.querySelectorAll('nav p a');   
...
const populateTemplate = (repositories) => {
  const repositoryNode = document.createElement("div");
  repositoryNode.className = "repositories";
  repositoryNode.innerHTML = `
    <div class="repositories-details">
    <h4><a href="${repositories.url}">${repositories.name}</a></h4>
    ${repositories.parent ? 
      '<span class="repository__parent">Forked from <a href="' + repositories.parent.url + 
      '\" class="fork">' + repositories.parent.name + '</a></span>':
      ""
      }
    <button class="repo-star"><img src="img/star-regular.svg" width="10" alt=""> <span>Star</span></button>
</div>

<p class="repository__description">
<a href ="${repositories.description ? repositories.description : ""}">${repositories.description ? repositories.description : ""}</a>
</p>  <div class="repo-project">

<p class="repo-project-language">
${repositories.primaryLanguage ? 
  '<span class="language"><span class="circle" style="width:20px;color:' + repositories.primaryLanguage.color + '; background-color:' 
  + repositories.primaryLanguage.color + 
  ';"> O;</span>&nbsp;<span class="language__name">' + 
  repositories.primaryLanguage.name + '</span></span>':
  ""
}
<span> ${repositories.stargazerCount ?
  '<span class="stars"><a href="https://github.com/Mcdonald61/' + repositories.name + '/stargazers">' +
    ...
    '&nbsp;' + repositories.stargazerCount + 
  '</a></span>':
  ""
}
${repositories.forkCount || (repositories.parent ? repositories.parent.forkCount: undefined) ?
  '<span class="pulls">' +
    '<a href="https://github.com/Mcdonald61/'+ repositories.name + '/network/members">' +
    '<svg aria-label="fork" viewBox="0 0 16 16" version="1.1" width="16" height="16" role="img"><path fill="#6a737d" fill-rule="evenodd" d="M5 3.25a.75.75 0 11-1.5 0 .75.75 0 011.5 0zm0 2.122a2.25 2.25 0 10-1.5 0v.878A2.25 2.25 0 005.75 8.5h1.5v2.128a2.251 2.251 0 101.5 0V8.5h1.5a2.25 2.25 0 002.25-2.25v-.878a2.25 2.25 0 10-1.5 0v.878a.75.75 0 01-.75.75h-4.5A.75.75 0 015 6.25v-.878zm3.75 7.378a.75.75 0 11-1.5 0 .75.75 0 011.5 0zm3-8.75a.75.75 0 100-1.5.75.75 0 000 1.5z"></path></svg>' +
      '&nbsp;'+ (repositories.forkCount || repositories.parent.forkCount) +
    '</a>' +
  '</span>':
  ""
}
${repositories.licenseInfo ?
  '<span class="cert">' +
    ...
    '&nbsp;' + repositories.licenseInfo.name +
  '</span>' :
  ""
}
<span class="last-updated">Updated ${formatDate(repositories.updatedAt)}</span>
</div>
</div>
<div>
</p>
...
const getReposData = (repositories) => {
  ...
  document.querySelectorAll("repo-total-count")
...
const getUserData = (object) => {
  document.querySelector(".no").textContent =object.repositories.edges.length
  // document.querySelector(".name").textContent = object.name;
  // document.querySelector(".description").textContent = object.bio;
  document.querySelectorAll(".mypic").forEach( img => img.src = object.avatarUrl);
...
fetch("https://api.github.com/graphql", {
  method: 'POST', 
  headers:{Authorization: "bearer e40b53c83ece647b8bbc2861610cb7bcfa099088"}, 
